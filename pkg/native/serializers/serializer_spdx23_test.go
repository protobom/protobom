...
func TestSpdxNamespaceFromProtobomID(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			// The fragment the SPDX 2 unserializers write into the
			// protobom identifier, so reading and writing a document keeps
			// its namespace.
			name:     "plain-uri-unserializer-fragment",
			sut:      "https://spdx.org/spdxdocs/48ddaa40-309a-40f7-8a8a-643a2262b144#DOCUMENT",
			expected: "https://spdx.org/spdxdocs/48ddaa40-309a-40f7-8a8a-643a2262b144",
			options:  DefaultSPDX23Options,
			mustErr:  false,
		},
		{
			name:     "plain-uri-empty-fragment",
			sut:      "https://spdx.org/spdxdocs/48ddaa40-309a-40f7-8a8a-643a2262b144#",
			expected: "https://spdx.org/spdxdocs/48ddaa40-309a-40f7-8a8a-643a2262b144",
			options:  DefaultSPDX23Options,
			mustErr:  false,
		},
		{
			name:     "plain-uri-lowercase-fragment",
			sut:      "https://spdx.org/spdxdocs/48ddaa40-309a-40f7-8a8a-643a2262b144#document",
			expected: "urn", // Only the SPDX document identifiers are accepted
			options:  DefaultSPDX23Options,
			mustErr:  false,
		},
		{
		...
		{
			name:     "urn-unserializer-fragment",
			sut:      "urn:uuid:3e671687-395b-41f5-a30f-a58921a69b79#DOCUMENT",
			expected: "urn:uuid:3e671687-395b-41f5-a30f-a58921a69b79",
			options:  DefaultSPDX23Options,
		},
		{
			// The fragment is "b#DOCUMENT", which does not name the document.
			name:     "plain-uri-nested-fragment",
			sut:      "https://example.com/a#b#DOCUMENT",
			expected: "urn",
			options:  DefaultSPDX23Options,
		},
		{
			// A percent-encoded fragment names the same document.
			name:     "plain-uri-escaped-fragment",
			sut:      "https://example.com/ns#SPDXRef%2DDOCUMENT",
			expected: "https://example.com/ns",
			options:  DefaultSPDX23Options,
		},
		{
			name:     "plain-uri-query-and-fragment",
			sut:      "https://example.com/ns?version=2#DOCUMENT",
			expected: "https://example.com/ns?version=2",
			options:  DefaultSPDX23Options,
		},
		{
			name:     "urn",
