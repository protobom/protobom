...
const (
	...
	NodeIdentifierPrefix = "protobom"
	// NodeIdentifierPrefixAuto marks identifiers autogenerated by protobom.
	NodeIdentifierPrefixAuto = "auto"
	// NodeIdentifierPrefixNode marks node-derived identifiers.
	NodeIdentifierPrefixNode = "node"
)
...
var (
	...
	protobomPrefixes = map[string]string{
		NodeIdentifierPrefixAuto: NodeIdentifierPrefixAuto,
		NodeIdentifierPrefixNode: NodeIdentifierPrefixNode,
	}
)
