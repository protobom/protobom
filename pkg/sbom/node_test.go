...
func TestNodeFlatString(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			"bomsquad.protobom.Node.build_date:1700166898:bomsquad.protobom.Node.copyright:Copyright (c) 2023 The Protobom Authors:bomsquad.protobom.Node.file_name:test.tar.gz:bomsquad.protobom.Node.hashes:3:b51261db1ecadecf85274e811e537c5811a0ad1ab2a0121aeac4e3d031e1bf83:bomsquad.protobom.Node.id:node-id:bomsquad.protobom.Node.license_comments:Comment on the license:bomsquad.protobom.Node.license_concluded:Apache-2.0:bomsquad.protobom.Node.name:test node:bomsquad.protobom.Node.release_date:1700080498:bomsquad.protobom.Node.url_download:http://example.com/file.tar.gz:bomsquad.protobom.Node.url_home:http://example.com/:bomsquad.protobom.Node.valid_until_date:1700253298:bomsquad.protobom.Node.version:1.0.0:extref:(t)VCS(u)http://github.com/external(c)GitHub Link:identifiers[1]:pkg:/apk/wolfi/bash@4.1.11:originator:n(The Open Source Authors)o(false)email(noone@example.com)url(http://github.com/example)p(987-5432):primary_purpose:CONTAINER:supplier:n(ACME, Inc)o(true)email(acme@example.com)url(http://acme-fixtures.com)p(123-3456)",
		},
		{
			&Node{
				Id:                 "node-2",
			...
			"bomsquad.protobom.Node.attribution[0]:Copyright 2003 The Protobom Authors:bomsquad.protobom.Node.comment:This a test file to check serialization:bomsquad.protobom.Node.copyright:Copyright (c) 2023 The Protobom Authors:bomsquad.protobom.Node.description:Descr:bomsquad.protobom.Node.file_name:textfile.txt:bomsquad.protobom.Node.hashes:2:7df059597099bb7dcf25d2a9aedfaf4465f72d8d3:b51261db1ecadecf85274e811e537c5811a0ad1ab2a0121aeac4e3d031e1bf835:dc6b68d13b8cf959644b935f1192b02c71aa7a5cf653bd43b4480fa89eec8d4d3f16a2278ec8c3b40ab1fdb233b3173a78fd83590d6f739e0c9e8ff56c282557:bomsquad.protobom.Node.id:node-2:bomsquad.protobom.Node.license_comments:Test license, ignore:bomsquad.protobom.Node.license_concluded:Apache-2.0:bomsquad.protobom.Node.name:textfile.txt:bomsquad.protobom.Node.summary:Test:bomsquad.protobom.Node.type:1:bomsquad.protobom.Node.url_download:http://example.com/file.tar.gz:bomsquad.protobom.Node.url_home:http://example.com/:primary_purpose:FILE",
		},
	} {
		s := tc.sut.flatString()
