	...
	for _, tc := range []struct {
	...
	}{
		{
			&Node{
				...
				SourceInfo:       "",
				PrimaryPurpose:   Purpose_CONTAINER,
				Comment:          "",
				Summary:          "",
				Description:      "",
				Suppliers: []*Person{
