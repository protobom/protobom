...
// Kind of file a node stands for, when the node is a file.
type Node_FileKind int32

const (
	// The kind of file is not stated.
	Node_UNKNOWN_FILE_KIND Node_FileKind = 0
	// The node is a file.
	Node_FILE_KIND_FILE Node_FileKind = 1
	// The node is a directory.
	Node_FILE_KIND_DIRECTORY Node_FileKind = 2
)

// Enum value maps for Node_FileKind.
var (
	Node_FileKind_name = map[int32]string{
		0: "UNKNOWN_FILE_KIND",
		1: "FILE_KIND_FILE",
		2: "FILE_KIND_DIRECTORY",
	}
	Node_FileKind_value = map[string]int32{
		"UNKNOWN_FILE_KIND":   0,
		"FILE_KIND_FILE":      1,
...
func (x Node_FileKind) Enum() *Node_FileKind {
	p := new(Node_FileKind)
	*p = x
	return p
}

func (x Node_FileKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Node_FileKind) Descriptor() protoreflect.EnumDescriptor {
	return file_sbom_proto_enumTypes[7].Descriptor()
}

func (Node_FileKind) Type() protoreflect.EnumType {
	return &file_sbom_proto_enumTypes[7]
}

func (x Node_FileKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Node_FileKind.Descriptor instead.
func (Node_FileKind) EnumDescriptor() ([]byte, []int) {
...
type Node struct {
	...
	// Media type of the node's contents, as defined by RFC 6838. For example
	// "text/plain" or "image/png". SPDX 3 calls this contentType and
	// CycloneDX calls it mimeType.
	ContentType string `protobuf:"bytes,32,opt,name=content_type,json=contentType,proto3" json:"content_type,omitempty"`
	// Kind of file the node is, when it is a file: whether it is a file
	// proper or a directory. Empty for packages.
	FileKind      Node_FileKind `protobuf:"varint,33,opt,name=file_kind,json=fileKind,proto3,enum=protobom.protobom.Node_FileKind" json:"file_kind,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Node) GetFileKind() Node_FileKind {
	if x != nil {
		return x.FileKind
	}
	return Node_UNKNOWN_FILE_KIND
}
...
type Person struct {
	...
	// Indicates whether the entity is a piece of software acting on its own
	// behalf, such as a scanner or a build system, rather than a person or an
	// organization. An entity cannot be both this and an organization.
	IsSoftwareAgent bool `protobuf:"varint,7,opt,name=is_software_agent,json=isSoftwareAgent,proto3" json:"is_software_agent,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Person) GetIsSoftwareAgent() bool {
	if x != nil {
		return x.IsSoftwareAgent
	}
	return false
}
...
const file_sbom_proto_rawDesc = "" +
	...
	"\tfile_kind\x18! \x01(\x0e2 .protobom.protobom.Node.FileKindR\bfileKind\x1a>\n" +
	...
	"\x04FILE\x10\x01\"N\n" +
	"\bFileKind\x12\x15\n" +
	"\x11UNKNOWN_FILE_KIND\x10\x00\x12\x12\n" +
	"\x0eFILE_KIND_FILE\x10\x01\x12\x17\n" +
	"\x13FILE_KIND_DIRECTORY\x10\x02J\x04\b\f\x10\rJ\x04\b\x0e\x10\x0fJ\x04\b\x19\x10\x1a\"\x8d\x01\n" +
	"\bNodeList\x12-\n" +
	...
	"\rroot_elements\x18\x03 \x03(\tR\frootElements\"\xd4\x01\n" +
	"\x06Person\x12\x12\n" +
	...
	"\bcontacts\x18\x06 \x03(\v2\x19.protobom.protobom.PersonR\bcontacts\x12*\n" +
	"\x11is_software_agent\x18\a \x01(\bR\x0fisSoftwareAgent\"2\n" +
	"\bProperty\x12\x12\n" +
...
var file_sbom_proto_goTypes = []any{
	...
	(Node_FileKind)(0),                           // 7: protobom.protobom.Node.FileKind
...
var file_sbom_proto_depIdxs = []int32{
	...
	7,  // 22: protobom.protobom.Node.file_kind:type_name -> protobom.protobom.Node.FileKind
