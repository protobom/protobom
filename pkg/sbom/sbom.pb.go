...
const (
	...
	Purpose_APPLICATION            Purpose = 1  // Application purpose. (SPDX2.3, CDX1.6, SPDX3.0)
	...
	Purpose_CONTAINER              Purpose = 5  // Container purpose. (SPDX2.3, CDX1.6, SPDX3.0)
	Purpose_DATA                   Purpose = 6  // Data purpose. (CDX1.6, SPDX3.0)
	Purpose_DEVICE                 Purpose = 7  // Device purpose. (SPDX2.3, CDX1.6, SPDX3.0)
	Purpose_DEVICE_DRIVER          Purpose = 8  // Device Driver purpose. (CDX1.6, SPDX3.0)
	...
	Purpose_FILE                   Purpose = 12 // File purpose. (SPDX2.3, CDX1.6, SPDX3.0)
	Purpose_FIRMWARE               Purpose = 13 // Firmware purpose. (SPDX2.3, CDX1.6, SPDX3.0)
	Purpose_FRAMEWORK              Purpose = 14 // Framework purpose. (SPDX2.3, CDX1.6, SPDX3.0)
	Purpose_INSTALL                Purpose = 15 // Install purpose. (SPDX2.3, SPDX3.0)
	Purpose_LIBRARY                Purpose = 16 // Library purpose. (SPDX2.3, CDX1.6, SPDX3.0)
	Purpose_MACHINE_LEARNING_MODEL Purpose = 17 // Machine Learning Model purpose. (CDX1.6)
	...
	Purpose_OPERATING_SYSTEM       Purpose = 21 // Operating System purpose. (SPDX2.3, CDX1.6, SPDX3.0)
	Purpose_OTHER                  Purpose = 22 // Other purpose. (SPDX2.3, SPDX3.0)
	Purpose_PATCH                  Purpose = 23 // Patch purpose. (SPDX3.0)
	Purpose_PLATFORM               Purpose = 24 // Platform purpose. (SPDX2.3, CDX1.6, SPDX3.0)
