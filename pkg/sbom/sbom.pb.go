...
var file_api_sbom_proto_goTypes = []any{
...
func file_api_sbom_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_sbom_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_sbom_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_sbom_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_api_sbom_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Edge); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_sbom_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_api_sbom_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Person); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_sbom_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Tool); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_sbom_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_api_sbom_proto_msgTypes[8].Exporter = func(v any, i int) any {
	...
	file_api_sbom_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
