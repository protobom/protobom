...
type ExternalReferenceORM struct {
	Authority string `gorm:"uniqueIndex:idx_external_reference"`
	Comment   string `gorm:"uniqueIndex:idx_external_reference"`
	NodeId    *string
	Type      int32
	Url       string `gorm:"uniqueIndex:idx_external_reference"`
}
...
type PersonORM struct {
	...
	Phone             string `gorm:"uniqueIndex:idx_person"`
	SuppliersNodeId   *string
	Url               string `gorm:"uniqueIndex:idx_person"`
}
...
type ToolORM struct {
	...
	Version    string `gorm:"uniqueIndex:idx_tool"`
}
